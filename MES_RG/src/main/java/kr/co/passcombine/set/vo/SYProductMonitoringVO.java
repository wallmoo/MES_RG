...
public class SYProductMonitoringVO {
	...
	private String prev_product_po = "";
	private String prev_routing_code = "";
	private String prev_routing_seq = "";
	
	private String vwtable2 = "";
	...
	public String getBal_count() {
		return bal_count;
	}

	public void setBal_count(String bal_count) {
		this.bal_count = bal_count;
	}

	public String getBal_price() {
		return bal_price;
	}

	public void setBal_price(String bal_price) {
	...
	public String getPrev_product_po() {
		return prev_product_po;
	}

	public void setPrev_product_po(String prev_product_po) {
		this.prev_product_po = prev_product_po;
	}

	public String getPrev_routing_code() {
		return prev_routing_code;
	}

	public void setPrev_routing_code(String prev_routing_code) {
		this.prev_routing_code = prev_routing_code;
	}

	public String getPrev_routing_seq() {
		return prev_routing_seq;
	}

	public void setPrev_routing_seq(String prev_routing_seq) {
		this.prev_routing_seq = prev_routing_seq;
	}

	public String getVwtable2() {
		return vwtable2;
	}

	public void setVwtable2(String vwtable2) {
		this.vwtable2 = vwtable2;
	}
