...
public class SYWarehouseOutVo implements Serializable{

	private static final long serialVersionUID = 1L;
	
	private String out_date_doc;
	...
	public String getOut_date_doc() {
		return out_date_doc;
	}
	public void setOut_date_doc(String out_date_doc) {
		this.out_date_doc = out_date_doc;
	}
