...
@Controller
@RequestMapping("/info")
public class DOCompanyContronller {
	private static final Logger logger = LoggerFactory
			.getLogger(DOCompanyContronller.class);
	...
	// selectAccount
	@ResponseBody
	@RequestMapping(value = "/account/selectAccount", method = { RequestMethod.GET, RequestMethod.POST }, produces = "application/json;charset=UTF-8")
	@SuppressWarnings("unchecked")
