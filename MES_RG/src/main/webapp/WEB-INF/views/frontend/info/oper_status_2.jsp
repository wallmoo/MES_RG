	...
	function fnLoadCustomerGrid2(){
		// 	 console.log(page_url);
			...
			$('#grid_list2').w2grid({ 
		        ...
		        multiSelect: false,
		        columns: [       
					{ field:'date', caption:'일자', size:'12%', style:'text-align:center', sortable: true }, 
					{ field:'machine_code', caption:'설비코드', size:'12%', style:'text-align:center', sortable: true }, 			
					{ field:'prod_menge', caption:'생산수량', size:'20%', style:'text-align:center', sortable: true}, 
					{ field:'prod_fail_menge', caption:'불량수량', size:'20%', style:'text-align:center', sortable: true}, 
					{ field:'per', caption:'가동률', size:'10%', style:'text-align:center', sortable: true}, 
					{ field:'today_time_hour', caption:'총가동시간', size:'15%', style:'text-align:center', sortable: true},
					{ field:'work_time_hour', caption:'작업시간', size:'15%', style:'text-align:center', sortable: true}
					], 
				records: [],	//
				onReload: function(event) {
					//loadList();
