...
//    out_gubun.push(obj2); 
   ...
   $('#grid_list2').w2grid({ 
        ...
        columns: [   
                  ...
                  { field:'outsourcing_gubun_select', caption:'외주선택', size:'60px', style:'text-align:center' ,sortable :true},
      ...
      onSelect: function (event) {
    	  event.onComplete = function () {
				...
				var outsourcing_gubun_select = data.outsourcing_gubun_select;
				console.log('eventColumn : ' + eventColumn);
				console.log('routing_gubun : ' + routing_gubun);
				console.log('machine_gubun : ' + machine_gubun);
				console.log('outsourcing_gubun_select : ' + outsourcing_gubun_select);
			  	...
			  	if(routing_code.indexOf(finding) != -1){
...
// 	  	    		if(r = 0){
// 	  	    			 console.log("outObj.text는???--------0::" + row.text);
// 	  	  	    		 console.log("outObj.code는???--------0::" + row.code);
	  	    			
// 	  	    		}else{
// 	  	    			 console.log("outObj.text는???--------1::" + row.text);
// 	  	  	    		  console.log("outObj.code는???--------1::" + row.code);
// 	  	    		}
