...
<div class="wrapper">
 ...
 <div class="content-wrapper">
    <section class="content-header">
		<h1>
			 KPI 목표관리(매출) <small> 기준정보관리 </small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i>기준정보관리 </a></li>
			<li class="active">KPI 목표관리(매출)</li>
		</ol>
	</section>
...
$(function($) {
	...
	HashMap.prototype = {  
	    ...
	    clear : function(){ this.map = new Array();},  
	    getKeys : function(){ var keys = new Array();  
	        for(i in this.map){  
	            keys.push(i);
	        }  
	        return keys;
...
// 	 console.log('fnSetLoadWorkerGrid()');
	...
	$('#grid_list').w2grid({ 
        ...
        columns: [    
			...
			{ field:'customer_nm', caption:'고객사명', size:'100%', style:'text-align:center', padding:'30px', hidden : true}, 
			{ field:'customer_code', caption:'코드', size:'10%', style:'text-align:center', hidden : true},
			{ field:'flag', caption:'고객사명', size:'100%', style:'text-align:center', padding:'30px'
				
				,render: function (record, index, col_index) {
					var customer_nm = w2ui.grid_list.records[index].customer_nm;
	                ...
	                if(html == 'N')
	            	{
	            	   return customer_nm;
	            		...
	            		if(html == 'Y')
	            	{
	            		 return '<div style="background-color:#c3fc93; height=20px;">'+customer_nm+'</div>';
	            	}
	               return html;
	          	}
			}
...
// 				w2ui.itemGrid.recordHeight = 40;
			...
			/* 	 var data = 
				...
				// 오른쪽 그리드
				requestGoal(data.customer_code);
				grid_list_tot();
			}
		},
...

{
	...
	var pageUrl = "/info/customer/selectCustomer";
	...
	$.ajax({
		...
		success : function( data ) {
			...
			w2ui['grid_list'].sort('customer_nm','asc');
		}
	});
}
...
function requestGoal()
{
	...
	if( chkLen==0 ) {
		...
		var page_url = "/info/goal/selectGoalCustomer";
		var postData = 
...
//----------------------------------------------------------------------------------------
// 저장
function saveGoal(code, month, goal) {
	...
	var page_url  = "/info/goal/saveGoalCustomer";
