		...
		<div class="modal-content">
			...
			<div class="modal-body" id="modal_code_body">
				<form id="frm_routingItnbr" name="frm_routingItnbr" class="form-horizontal">	
					...
					<div class="row"><!-- 거래처명, 거래처코드, 대표자, 주소, 전화번호, 팩스, 이메일1,2,3, url, 사업자번호 -->
						<div class="form-group">
	...
	// 	 console.log(page_url);
		...
		$('#grid_list').w2grid({ 
	        ...
	        columns: [                
				...
				{ field:'vdr_ML1', caption:'이메일', size:'8%', style:'text-align:center', sortable: true},
				{ field:'vdr_ML2', caption:'이메일', size:'8%', style:'text-align:center', sortable: true},
				{ field:'vdr_ML3', caption:'이메일', size:'8%', style:'text-align:center', sortable: true},
