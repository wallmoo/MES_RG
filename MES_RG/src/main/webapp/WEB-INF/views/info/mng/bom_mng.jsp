...
/* 		var page_url = "/info/account/selectMaterial";
	...
	function requestGrid4(){
		...
		var postData = "stufe=1&item_type_code=MD1245&product_item_code=" + encodeURIComponent($('#hiddenProduct_code').val()) 
					+ "&c_item_code="+ encodeURIComponent($('#g4_item_type_code').val()) 
					+ "&c_item_nm="+ encodeURIComponent($('#g4_item_nm').val());
