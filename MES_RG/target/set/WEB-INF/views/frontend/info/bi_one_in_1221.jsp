...
function init_grid_list(){
	...
	$('#grid_list').w2grid({ 
        ...
        columns: [           
			...
			{ field:'in_ware_nm', caption:'입고창고', size:'8%', style:'text-align:center', sortable: true},// 200px
			...
			if(result) {
				...
				$.ajax({
					 ...
					 success:function(data, textStatus, jqXHR){
					 	if(data.status == "200") {
					 		console.log(data);
					 		var recids = w2ui.grid_list2.getSelection();
							var pdata = w2ui.grid_list2.get(recids[0]);
							loadList2(pdata.purchase_order_num, pdata.purchase_num);
					 		loadList();
