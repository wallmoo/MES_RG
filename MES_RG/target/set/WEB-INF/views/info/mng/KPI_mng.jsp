...
<div class="wrapper">
	...
	<jsp:include page="/common/sidebar_menu_inc" flush="true">
		...
		<jsp:param name="selected_menu_cd" value="1027" />
	</jsp:include>

 <div class="content-wrapper">
    <section class="content-header">
		<h1>
			 KPI 목표관리 <small> 기준정보관리 </small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i>기준정보관리 </a></li>
			<li class="active">KPI 목표관리</li>
		</ol>
	</section>
...
function requestGoal()
{
	...
	if( chkLen==0 ) {
		...
		var page_url = "/info/goal/selectGoal";
		var postData = 
...
function saveGoal(code, month, goal/* , sales */) {
	...
	var page_url  = "/info/goal/saveGoal";
