...
<!-- 														<button type="button" id="btn_ins_csr" onclick="insItem();" class="btn btn-primary btn-sm" onclick="">그룹추가</button> -->
							...
							onclick="excelFileDownload();">전품목 엑셀다운로드</button> 
													</div>
												</div>
												<div class="box-body">
													<div class="row">
		...
		onChange: function(event) {
			event.onComplete = function () {
				...
				if(eventColumn == 1) {
					...
					w2ui['modalGrid'].set( key , { routing_code: '', machine_gubun: ''});
					
					w2ui['modalGrid'].set( key , { routing_code : getrouting_gubun, machine_gubun: machine_gubun });
...
// 	var page_url = "/info/material/excelLoad";
...
// 					var gridObj = {}; 
// 					gridObj.field = "item_code"; 
// 					gridObj.caption = "P/N";
// 					gridObj.size = "15%";
// 					gridObj.style = "text-align:center";
// 					gridObj.sortable = true;
// 					gridObj.sizeType = "%";
// 					gridObj.sizeCalculated = "144px";
// 					gridObj.min = 20;
// 					gridObj.sizeCorrected = "20%";

// 					grid.push(gridObj);
					
// 					var gridObj2 = {}; 
// 					gridObj2.field = "routing_nm"; 
// 					gridObj2.caption = "공정명";
// 					gridObj2.size = "15%";
// 					gridObj2.style = "text-align:center";
// 					gridObj2.sortable = true;
// 					gridObj2.sizeType = "%";
// 					gridObj2.sizeCalculated = "144px";
// 					gridObj2.min = 20;
// 					gridObj2.sizeCorrected = "20%";
...
// 					var rouObj = {}; 
// 					rouObj.item_code = rowArr[i].item_code; 
// 					rouObj.routing_nm = rowArr[i].routing_nm;
					
// 					console.log("rouObj.item_code:::"+rouObj.item_code)
					
// 					//
// //  					var rnms = rowArr[i].routing_nm;
// //  					var sprnms = rnms.split(",");
					
// // 					for(var j = 0; j < sprnms.length; j ++){
						
// // 						rouObj.routing_nm = sprnms[j];
...
// 				console.log("JSON.stringify(total):::"+JSON.stringify(total));
// 				}
				
// 				$.each(rowArr, function(idx, row){
// 					row.recid = idx+1;
// // 					console.log("rowArr.item_code::::"+rowArr[idx].item_code);
// // 					console.log("rowArr.routing_nm::::"+rowArr[idx].routing_nm);
// // 					var rms =[];
// // 					rms = rowArr[idx].routing_nm;
// // 					icArr.push(rms);
// // 					console.log("icArr"+icArr);
// 				});
...
// 	var page_url = "/info/material/excelMax";
